...
description: |
  第二记忆大脑 — 自动保存知识到 Zettelkasten，建立双向链接，
  评估知识健康度，需要时检索。
---
...
```yaml
sensitivity: 0.6      # 记录敏感度 (0.1-1.0)
search_depth: 20    # 搜索深度 (5-50)
link_threshold: 0.6 # 关联阈值 (0.1-0.9)
tag_limit: 3          # 标签数量 (2-5)
auto_archive: true    # 自动归档 (true/false)
```
